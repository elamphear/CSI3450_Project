		...
		if ($myremoveuser == "")
		{
			...
			elseif($myusername == "" || $mypassword == "" || $myfname == "" || $mylname == "" || $myemail == "" && $myremoveuser == "")
			{
	      	...
	      	elseif($myusername != "" && $mypassword != "" && $myfname != "" && $mylname != "" && $myemail != "" && $mypremiumflag != "" && $myadminuser != "")
	      	{
			    ...
			    $sql = "INSERT INTO `users`(`userid`,`username`,`password`,`userfname`,`userlname`,`email`,`subscriptionstatus`,`adminflag`) VALUES ('','$myusername','$mypassword','$myfname','$mylname','$myemail','$mypremiumflag','$myadminuser')";
